...
![Exactitud vs cantidad de atributos(Gini)](images/gini.png)
![Exactitud vs cantidad de atributos(Entropy)](images/entropy.png)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/elciclon/english-alphabet-classification-model.git
